...
public class UserActivty extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference dataadmin = FirebaseDatabase.getInstance().getReference().child("Admin").child(phone);
        dataadmin.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                userid = (String) snapshot.child("uid").getValue();
                    u1();
    ...
    public void u1()
    {
        ...
        RootRef.child("Users").child(userid).child(phone).addValueEventListener(new ValueEventListener() {
            @Override
                ...
                if (mode.equals("on")) {
                    RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            RootRef.child("Users").child(userid).child(phone).child("mode").setValue("off");
                            String currentDateTimeString = java.text.DateFormat.getDateTimeInstance().format(new Date());

                            RootRef.child("Users").child(userid).child(phone).child(date).child("modeoffdatetime").setValue(currentDateTimeString);
                            ...
                            if (location == null) {
                                ...
                                Toast.makeText(UserActivty.this,"Your Live Location Is Off", Toast.LENGTH_SHORT).show();
                    ...
                    RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            RootRef.child("Users").child(userid).child(phone).child("mode").setValue("on");
                            ...
                            userDataMap.put("lat", "");
                            userDataMap.put("long", "");
                            userDataMap.put("modeoffdatetime", "");

                            RootRef.child("Users").child(userid).child(phone).child(date).updateChildren(userDataMap);
                            ...
                            if (location == null) {
                                ...
                                Toast.makeText(UserActivty.this,"Your Location Sucessfully Updated : " + currentLatitude + "  " + currentLongitude + "", Toast.LENGTH_SHORT).show();
    ...
    public void onConnected(Bundle bundle) {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.child("Users").child(userid).child(phone).child("mode").getValue().equals("on")) {
    ...
    private void saveLocationToDB(double currentLatitude, double currentLongitude) {
        ...
        HashMap<String, Object> userDataMap = new HashMap<>();
        userDataMap.put("lat", String.valueOf(currentLatitude));
        userDataMap.put("long",String.valueOf(currentLongitude));
        RootRef.child("Users").child(userid).child(phone).child(date).updateChildren(userDataMap);
    ...
    public void onLocationChanged(Location location) {
        currentLatitude = location.getLatitude();
        currentLongitude = location.getLongitude();
        Toast.makeText(UserActivty.this,"Your Location Sucessfully Updated : " + currentLatitude + "  " + currentLongitude + "", Toast.LENGTH_LONG).show();
        saveLocationToDB(currentLatitude,currentLongitude);
    }
